...
# main function
def visualize_graphml(graphml_file, html_path, port=8000, json_file = 'graph_json.js'):
    json_data = graphml_to_json(graphml_file)
    print("path:", html_path)

    html_dir =  html_path.split(".")[0] #os.path.dirname(html_path)
    print("dirtectory:", html_dir)
    if not os.path.exists(html_dir):
        print(html_dir)
        os.makedirs(html_dir)

    json_path = html_path.split(".")[0] #os.path.join(html_dir, json_file)
...
def create_html_from_graphml(graphml_file, html_path, port=8000, json_file = 'graph_json.js'):
    json_data = graphml_to_json(graphml_file)
    print("path:", html_path)
...
root = "/root/projects/nano-graphrag/biomedical/"
...
file = root+folder+"/graph_chunk_entity_relation.graphml"
